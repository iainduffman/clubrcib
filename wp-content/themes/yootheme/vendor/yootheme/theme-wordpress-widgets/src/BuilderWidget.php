...
class BuilderWidget extends WP_Widget
{
    ...
    public function form($instance)
    {
        ...
        $settings = array_merge($this->widget_options['settings'], $instance);
        $content = json_encode($this->builder->load($settings['content']));

        wp_enqueue_script('widget-builder', get_template_directory_uri() . '/vendor/yootheme/theme-wordpress-widgets/app/widget-builder.min.js');
